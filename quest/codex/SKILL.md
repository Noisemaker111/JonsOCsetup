...
Keep assignments and decisions in the main agent and compose the concrete tools
with Code Mode. Shared records require no OpenCode worker dispatch. This adapter
has not verified native delegation; do the work in the current session.

Record one-line check outcomes and attach actual deliverables. Keep implementation,
verification and integration as separate steps. The runtime preserves tool results
