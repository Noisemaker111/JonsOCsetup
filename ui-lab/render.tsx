 ...
 *
 * Component previews are design aids. They do not exercise the installed host,
 * native slots or interaction; use runtime:drive for acceptance evidence.
 */
...
export async function renderLab(only: string[] = [], size?: { width?: number; height?: number }, real = false) {
  ...
  try {
    for (const surface of chosen) {
      ...
      // Slot surfaces receive the host terminal dimensions.
