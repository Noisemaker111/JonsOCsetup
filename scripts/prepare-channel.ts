...
import {ensureHostModelCatalog,git} from './channel-prepare.mjs'
...
const evidence={ok,sourceCommit:source.commit,model,modelCatalog,outcome,loads,realProvider:true}
