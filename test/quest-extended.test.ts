...
test("work completion remains active until explicit user turn-in and survives reload", () => {
  ...
  store.create({ id, title: "Turn in", objective: "x", kind: "investigation", usageInstructions: ["Use the finished result"], completionPolicy: { requireSessions: false, requireCommits: false, requireTests: false, requireReview: false, requireArtifacts: false, requirePublish: false, requireWorktreeEquality: false } })
...
test("generated Quest log keeps finished work visible with a turn-in action", () => {
  ...
  store.create({ id, title: "Finished log entry", objective: "x", kind: "investigation", usageInstructions: ["Use the finished result"], completionPolicy: { requireSessions: false, requireCommits: false, requireTests: false, requireReview: false, requireArtifacts: false, requirePublish: false, requireWorktreeEquality: false } })
