...
When reporting to Jon, call development `agents`. Say "merged into agents and tested in OpenCode"; do not introduce "dev release" or "verified build" as another stage. Existing channel keys and command arguments are internal implementation details.
