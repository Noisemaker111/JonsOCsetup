> Historical implementation record. Use [current usage pacing](../usage-reset-planning.md); old model prices, scripts, and defaults below are not current instructions.
