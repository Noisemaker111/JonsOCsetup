---
name: convex
description: "Convex platform reference (schema, functions, scheduling, storage, auth, realtime). Use when writing or changing Convex backend code and the object-form function syntax or validators are in question."
---
